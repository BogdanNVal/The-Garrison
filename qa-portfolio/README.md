...
This folder is what I produced while testing it — plan, cases, bugs I found (and ones I re-checked after the project fixes on main), checklists, and a short Playwright smoke pack.
